...
echo "   OK: run_edge.sh exists and is executable"
...
echo "   OK: Tauri configuration includes resources"
...
echo "   OK: Venv size reasonable: ${VENV_SIZE_MB}MB"

# Test 8: Simulate launcher startup (without network)
echo "Test 8: Verifying launcher script syntax..."
bash -n "$RESOURCES_DIR/run_edge.sh"
echo "   OK: Launcher script syntax is valid"
